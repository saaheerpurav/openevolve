...
|---|---|---|
| single_agent_30 | 3/3 | 3/3 |
| tdes_full | 3/3 | 3/3 |
| tdes_no_crossover | 3/3 | 3/3 |

## Crossover Activity (tdes_full only)

| Design | seed | attempts | accepted | total_passes |
|---|---|---|---|---|
| fp_mult_pipeline | 0 | 0 | 0 | 59/59 |
| fp_mult_pipeline | 1 | 0 | 0 | 59/59 |
| fp_mult_pipeline | 2 | 0 | 0 | 59/59 |
...
|---|---|---|---|---|---|
| fp_mult_pipeline | single_agent_30 | SOLVED | SOLVED | SOLVED | 6 |
| fp_mult_pipeline | tdes_full | SOLVED | SOLVED | SOLVED | 18 |
| fp_mult_pipeline | tdes_no_crossover | SOLVED | SOLVED | SOLVED | 18 |
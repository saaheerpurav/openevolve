...
module fpm_unpack(
    ...
    wire a_exp_all_zeros = (a[30:23] == 8'h00);
    ...
    assign a_is_zero = a_exp_all_zeros & ~a_mant_nonzero;
    ...
    wire b_exp_all_zeros = (b[30:23] == 8'h00);
    ...
    assign b_is_zero = b_exp_all_zeros & ~b_mant_nonzero;
